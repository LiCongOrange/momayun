<template>
	...
	>
		<div class=""  v-if="browserToggle">
			<div class="login-wrap">

				<div class="title-top container" :class="{ width96: allEditToggle }" v-if="!this.navFixed">
					<div class="img-wrap">
						<h5 v-if="allEditToggle"><fn-editor :content="modelInfo.wsname || '站点名称'" :type1="0"></fn-editor></h5>
						<h5 v-else v-html="modelInfo.wsname"></h5>
					</div>
					<div class="btn-wrap">
						<p>
							<i class="iconfont">&#xe655;</i>
							<font v-if="allEditToggle">
								<fn-editor 
									:content="modelInfo.telephone" 
									:type1="0" 
									:type2="2" 
								></fn-editor>
							</font>
				...
				<div class="text-wrap">
					<ul class="container" v-if="pageToggle">
						<li 
