	...
	methods: {
		...
		addList() {
			let obj = {
				...
				nameFn: "<p class='ql-align-left'><span class='ql-font-serif'>副文本标语</span></p>",
				past: "<p class='ql-align-left'><span class='ql-font-serif'>我们的使命是解决各种行业的重要问题以及建立社会信任。</span></p>",
