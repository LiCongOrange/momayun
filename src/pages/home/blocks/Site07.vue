				...
				<draggable v-model="modelInfo.productList" :options="{animation: 300, handle: '.list-complete-item'}" v-if="allEditToggle">
	            	...
	            	></up-img>
							...
							<div class="text">
								...
								<div v-if="ite.btnToggle" class="p-btn2">
									<button class="btn btn-default" @click="todetailHandel(ite)">{{ite.btnInfo.text}}</button>
								...
								<div v-else class="p-btn">
									<div v-if="!pageToggle">
										<span v-if="allEditToggle" @click="addbtnHandel(index, ite.pid)">添加按钮</span>
									</div>
								</div>
							</div>
						</li>
