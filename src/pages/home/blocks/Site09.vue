		...
		<swiper :options="swiperOption" class="swiper-no-swiping">
			...
			>
	            ...
	            <div class="mask" v-if="allEditToggle">
					...
					<div class="text">
						<div class="inner">
							<h3 @click="getIndex(index, 't', item.bid)" :style="{ opacity: opacityNum }">
							...
							<div class="btnEdit" v-if="item.btnToggle" @click="getIndex(index, 'b', item.bid)">
								<a 
									:href="item.btnInfo.link" 
									:target="item.btnInfo.target" 
									v-html="item.btnInfo.text" 
							...
							<div class="addBtn" v-else>
								<span v-if="allEditToggle" @click="addBtnlist(index)">添加按钮</span>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="contentinner container" :class="item.layoutClass" v-else>
					...
					<div class="text">
						<div class="inner">
							<h3 v-html="item.title" :class="{animated: isanimated1, fadeInRight: isfade1}"></h3>
							<p class="version" v-html="item.content" :class="{animated: isanimated1, fadeInRight: isfade1}"></p>
							<div class="btnEdit" v-if="item.btnToggle">
								<a 
									:href="item.btnInfo.link" 
									:target="item.btnInfo.target" 
									v-html="item.btnInfo.text"
