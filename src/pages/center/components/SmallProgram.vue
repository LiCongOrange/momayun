				...
				>
					<div :class="{ active:item.proid==isActive }">
						...
						<p>
							<span>空间容量无限制</span>
							<span>带宽流量无限制</span>
							<span v-if="item.title == '小程序标准版'">标准版展示组件使用</span>
							<span v-else>高级营销功能组件使用</span>
	...
	.siteTab
		...
		ul
			li
				margin-bottom: 30px
				div
					background: #fff url('/static/images/productCenter/xiaochengxu.png') no-repeat
