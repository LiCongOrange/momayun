<template>
  <div class="product" ref="product1" :class="modelInfo.bgClass">
    <fn-assembly 
      :btnChoice="btnChoice"
      :zLetter="zLetter" 
      :zLayout="zLayout"
        ...
        <draggable v-model="modelInfo.productList" :options="{animation: 300, handle: '.list-complete-item'}" v-if="allEditToggle">
          <transition-group name="list-complete" tag="ul">
            <li 
              ...
              :key="ite.pid" 
              class="list-complete-item col-md-3 col-sm-6 col-xs-12 " 
  ...
  methods: {
    handleScroll() {
      if(this.allEditToggle) {
        ...
        let htmlT = this.$refs.product1.getBoundingClientRect().top
        if(htmlT <= 560) {
